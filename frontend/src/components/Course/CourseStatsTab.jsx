    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Estadísticas del Curso</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">Métricas y rendimiento general</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-l-4 border-indigo-600">
          ...
          <p className="text-3xl font-bold text-gray-800 dark:text-gray-100">{stats.studentsCount}</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-l-4 border-purple-600">
          ...
          <p className="text-3xl font-bold text-gray-800 dark:text-gray-100">{stats.totalClasses}</p>
          <p className="text-sm text-gray-600 dark:text-gray-400">Clases Totales</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-l-4 border-pink-600">
          ...
          <p className="text-3xl font-bold text-gray-800 dark:text-gray-100">{stats.quizzesCount}</p>
          <p className="text-sm text-gray-600 dark:text-gray-400">Quizzes Activos</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-l-4 border-green-600">
          ...
          <p className="text-3xl font-bold text-gray-800 dark:text-gray-100">{stats.averageScore}%</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-bold text-gray-800 dark:text-gray-100">Tasa de Finalización</h3>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-bold text-gray-800 dark:text-gray-100">Tasa de Aprobación</h3>
          </div>
          <div className="relative">
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-4 overflow-hidden">
              <div
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-bold text-gray-800 dark:text-gray-100">Asistencia Promedio</h3>
          </div>
          <div className="relative">
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-4 overflow-hidden">
              <div
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-bold text-gray-800 dark:text-gray-100">Promedio por Quiz</h3>
          </div>
      ...
      {stats.weeklyActivity && stats.weeklyActivity.length > 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="font-bold text-gray-800 dark:text-gray-100 text-lg">Actividad Semanal (Últimas 4 semanas)</h3>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div className="flex items-center gap-3 mb-4">
          <Users className="text-indigo-600" size={24} />
          <h3 className="font-bold text-gray-800 dark:text-gray-100 text-lg">Rendimiento de Estudiantes</h3>
        </div>
        {stats.studentScores.length > 0 ? (
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  ...
                  <th className="text-center py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Quizzes</th>
                  ...
                  <th className="text-center py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Horas en Vivo</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 dark:text-gray-400 font-semibold">No hay estudiantes inscritos</p>
