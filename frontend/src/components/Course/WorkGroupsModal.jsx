...
const WorkGroupsModal = ({ isOpen, onClose, course, students }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl max-w-6xl w-full max-h-[90vh] shadow-2xl border border-gray-200 flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-800">Distribuir Grupos de Trabajo</h2>
              <p className="text-sm text-gray-500">{course?.code} - {students.length} estudiantes</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Messages */}
        {error && (
          <div className="mx-6 mt-4 bg-red-50/20 border border-red-200 rounded-lg p-3 flex items-center gap-2">
        ...
        {success && (
          <div className="mx-6 mt-4 bg-green-50/20 border border-green-200 rounded-lg p-3 flex items-center gap-2">
        ...
        <div className="p-6 border-b border-gray-200 bg-gray-50/50">
          <div className="flex items-center gap-3 flex-wrap">
            <button
              onClick={addGroup}
              className="flex items-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600:bg-blue-700 text-white rounded-lg transition font-medium"
            >
              <Plus size={18} />
              Agregar Grupo
            </button>
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-purple-500 hover:bg-purple-600:bg-purple-700 text-white rounded-lg transition font-medium"
            >
              <Shuffle size={18} />
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-gray-800 mb-4">Grupos Creados</h3>
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    <input
                      ...
                      className="flex-1 px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-800 font-semibold focus:outline-none focus:ring-2 focus:ring-purple-500"
                    />
                    <button
                      onClick={() => removeGroup(index)}
                      className="p-2 text-red-500 hover:bg-red-50:bg-red-900/20 rounded-lg transition"
                    ...
                    {group.students.length > 0 ? (
                      <div className="space-y-1">
                        {group.students.map(student => (
                          <div
                            key={student.id}
                            className="flex items-center gap-2 p-2 bg-purple-50/20 border border-purple-200 rounded text-sm"
                          >
                      ...
                      <p className="text-sm text-gray-400 italic">Sin integrantes</p>
                    )}
                  </div>
                </div>
              ))}
            ...
            {/* Students List */}
            <div>
              <h3 className="text-lg font-bold text-gray-800 mb-4">Estudiantes Disponibles</h3>
                ...
                {students.length > 0 ? (
                  <div className="space-y-2">
                    {students.map(student => {
                      ...
                      return (
                        <div key={student.id} className="border-b border-gray-200 last:border-0 pb-2">
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50/50">
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="flex-1 px-4 py-2 bg-gray-200 hover:bg-gray-300:bg-gray-600 text-gray-800 rounded-lg font-medium transition"
            >
              Cancelar
            </button>
            <button
