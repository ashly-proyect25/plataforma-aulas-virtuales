  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Compañeros de Clase</h2>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
          />
          {searchTerm && (
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredClassmates.map((classmate, index) => (
            <div
              ...
              className="bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition-all p-6 border border-gray-200 dark:border-gray-700"
            >
              {/* Avatar and Name */}
              <div className="flex flex-col items-center mb-4">
                ...
                <h3 className="font-bold text-gray-800 dark:text-gray-100 text-center text-lg">
                  {classmate.name}
                </h3>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg">
                  <Mail size={16} className="text-cyan-600 dark:text-cyan-400 flex-shrink-0" />
              ...
              <div className="mt-3 text-center">
                {classmate.workGroup ? (
                  <span className="px-3 py-1 bg-gradient-to-r from-cyan-100 to-blue-100 dark:from-cyan-900 dark:to-blue-900 text-cyan-700 dark:text-cyan-300 rounded-full text-xs font-semibold">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
        <h3 className="font-bold text-blue-900 dark:text-blue-100 mb-3">Información</h3>
