          ...
          {!results && (
            <div className="bg-gray-100 p-4 flex justify-between items-center">
              <div className="flex items-center gap-2">
                <Clock size={20} className={timeRemaining < 60 ? 'text-red-500' : 'text-gray-600'} />
                <span className={`font-bold ${timeRemaining < 60 ? 'text-red-500' : 'text-gray-700'}`}>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className={`p-6 rounded-lg ${results.passed ? 'bg-green-50' : 'bg-red-50'}`}>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className={`text-2xl font-bold ${results.passed ? 'text-green-800' : 'text-red-800'}`}>
                      {results.passed ? '¡Aprobado!' : 'No Aprobado'}
                    </h3>
                    <p className={`text-lg ${results.passed ? 'text-green-700' : 'text-red-700'}`}>
              ...
              <div className="space-y-4">
                <h4 className="font-bold text-lg text-gray-800">Resultados por pregunta:</h4>
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center mb-6">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300:bg-gray-500 transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <ChevronLeft size={20} />
                  Anterior
                </button>
                  ...
                  <button
                    ...
                    className={`transition-all ${
                      index === currentQuestion
                        ...
                        : 'w-8 h-8 rounded-full bg-gray-300 hover:bg-gray-400:bg-gray-500 text-gray-700'
                    }`}
